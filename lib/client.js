		...
		*/
		function decodeLimitTimeoutSettings(section) {
			...
			return {
				...
				suppressRepeatToolReminders: typeof suppressRepeatToolReminders === "boolean" ? suppressRepeatToolReminders : false
			};
		}
		//#endregion
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							handle.status.kind === "error" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: DESC_CLASS,
								children: handle.status.message
							}) : null
						]
					}),
					...
					dirty ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							onClick: handle.save,
							children: handle.status.kind === "saving" ? "保存中..." : "保存"
						...
						children: handle.status.kind === "saved" ? "已保存, 立即生效" : "未修改"
					})
				]
			});
		}
